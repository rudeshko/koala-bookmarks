          ...
          <>
            ...
            <ul>
              <li>
                ...
                the extension is open. You can enable and disable this feature
                in{" "}
                <b>
              ...
              <li>
                You can set a keyboard shortcut to open the extension by
                visiting <b className="link">chrome://extensions/shortcuts</b>{" "}
                and setting a value for <b>Activate the extension</b>. For
                example, <b>Ctrl+1 (Cmd+1)</b> can be used to open the extension
                while in Chrome. You can then access your websites by pressing{" "}
